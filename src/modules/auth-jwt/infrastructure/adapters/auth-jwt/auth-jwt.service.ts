...
import type { IAuthJwtService, TValidateRtOption } from '@auth-jwt/application/ports'
import { EXPIRES_IN_AT_MINUTES, EXPIRES_IN_RT_MINUTES } from '@auth-jwt/domain/helpers/constants'
import type { JwtInputData, JwtTokens, JwtPayload } from '@auth-jwt/domain/helpers/types'
import type { IAuthJwtRepository } from '@auth-jwt/domain/repositoryInterfaces'
import { RTSessionEntity } from '@auth-jwt/domain/entities'
...
export class AuthJwtService implements IAuthJwtService {
  constructor(
    ...
    public readonly authJwtRepository: IAuthJwtRepository<PrismaClient>,
  ) {}
